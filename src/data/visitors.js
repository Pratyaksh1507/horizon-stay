export const visitorsByCountry = {
  "United States": 18,
  "United Kingdom": 12,
  Germany: 17,
  France: 9,
...
export function getVisitorColor(feature) {
...
export function getVisitorValue(feature) {
  const name = feature.properties?.name;
  return visitorsByCountry[name];
}

export function computeVisitorTrend(visitors) {
